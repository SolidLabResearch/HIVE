...
async function main() {
    ...
    if (args.length < 2) {
        console.error('Usage: node experiment-frequency-fetching-with-capture.js <oscillation_type> <frequency>');
        console.error('Example: node experiment-frequency-fetching-with-capture.js complex_oscillation 0.1');
        process.exit(1);
    }
