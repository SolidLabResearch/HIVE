...
class MQTTInfrastructureTest {
    ...
    public async testMQTTInfrastructure(): Promise<void> {
        ...
        try {
            ...
            console.log('\n[OK] MQTT infrastructure test completed successfully!');
            console.log('\n Next steps:');
            ...
            console.error('\n[FAIL] MQTT infrastructure test failed:', error);
            console.log('\n Troubleshooting:');
    ...
    private async testConnectivity(): Promise<void> {
        return new Promise((resolve, reject) => {
            ...
            client.on('connect', () => {
                ...
                console.log('  [OK] Successfully connected to MQTT broker');
                client.end();
                resolve();
            });
                ...
                if (topic === testTopic) {
                    try {
                        ...
                        if (receivedData.test === true) {
                            ...
                            clearTimeout(timeout);
                            console.log('  [OK] Successfully published and received test message');
                            subscriber.end();
                            publisher.end();
                            resolve();
                        }
