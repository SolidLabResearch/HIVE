...
/**
 * 5-Iteration Multi-Run Verification Test
 * Runs all 3 streaming query approaches 5 times for quick validation.
 *
...
const NUM_RUNS = 5; // 5 iterations for quick testing
...
class MultiRunOrchestrator {
  ...
  async runMultipleTests(numRuns: number): Promise<void> {
    console.log("\n" + "=".repeat(70));
    console.log(`MULTI-RUN VERIFICATION: ${numRuns} ITERATIONS (QUICK TEST)`);
    console.log("=".repeat(70));
    console.log(
      `Testing all 3 approaches ${numRuns} times for quick validation`,
    );
    console.log("=".repeat(70));
