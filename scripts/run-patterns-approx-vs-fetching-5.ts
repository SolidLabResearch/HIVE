...
/**
 * 5-Iteration Pattern-Based Test for Approximation vs Ground Truth
 * Tests approximation and fetching approaches with pre-recorded stream patterns,
 * running 5 iterations for each pattern for quick validation.
 *
...
const ITERATIONS_PER_PATTERN = 5; // 5 iterations per pattern for quick testing
